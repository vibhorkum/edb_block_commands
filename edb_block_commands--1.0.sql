...
CREATE FUNCTION reedb_switch_user()
RETURNS text
AS 'MODULE_PATHNAME', 'edb_switch_user'
LANGUAGE C;

CREATE FUNCTION reedb_switch_user(text)
RETURNS text
AS 'MODULE_PATHNAME', 'edb_switch_user'
LANGUAGE C STRICT;

GRANT EXECUTE ON FUNCTION reedb_switch_user() TO PUBLIC;
GRANT EXECUTE ON FUNCTION reedb_switch_user(text) TO PUBLIC;
